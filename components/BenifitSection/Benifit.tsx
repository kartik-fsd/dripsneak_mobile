...
const benefitsData = [
  ...
  },
  {
    ...
    description:
      "Shop from hundreds of top collections and styles in one place.",
    icon: require("@/assets/icons/shoe-rack.png"),
  },
  {
    title: "Environmental-Friendly",
    description:
      "Explore eco-friendly options and make a positive impact on the environment.",
...
const BenefitsSection: React.FC = () => {
  return (
    <>
      <Text style={styles.headerText}>More Than Just a sneaker</Text>
...
const styles = StyleSheet.create({
  ...
  benefitItem: {
    flexBasis: "46%", // Adjust as needed for desired width
    alignItems: "center",
    padding: 15,
    marginVertical: 10,
    borderRadius: 8,
